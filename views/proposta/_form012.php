...
<div class="slo-proposta-form">
    <h4 class="titulo">Cônjuge: mais Informações <sup><span class="badge badge-primary"> 12 </span></sup>
    ...
    <a class="btn btn-primary" href="<?= Yii::$app->homeUrl.'proposta/pretendente001?form=011&id='.$model2->id .'&iddoc=' .$model->id .'&pretendente_id='.$pretendente_id.'&proposta_id='.$proposta_id ?>"><i class="fas fa-angle-double-left"></i> Voltar</a>
    <hr>
