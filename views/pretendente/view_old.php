<?php
    ...
    $this->params['breadcrumbs'][] = [
        'label' => 'Pretendentes', 
        'url' => [
            'index?PretendenteSearch[proposta_id]='.$model->proposta_id
        ]];
    ...
    <div class="slo-pretendente-view">
                ...
                $detailInfoPessoal = DetailView2::widget([
                    ...
                    'attributes'=>[
                        ...
                        [
                            ...
                            'format'=>'raw',
                            'value'=>$pessoais->possui_renda ? '<span class="label label-success">Sim</span>' : '<span class="label label-danger">Não</span>',
                            'type'=>DetailView2::INPUT_SWITCH,
                            'widgetOptions' => [
                                'pluginOptions' => [
                                    'onText' => 'Sim',
        ...
        <div class="col-md-12">
            ...
            <div class="col-md-2">
                <?php 
                    ...
                    */
                    ...
                    echo '<embed src="'.Yii::$app->homeUrl.'uploads/propostasdocs/'.$documentais->id.'_frentdoc_'.$documentais->frente_documento.'" 
            ...
            <div class="col-md-2">
                <?php 
                    Modal::begin([
                        'header' => '<h2>Selfie com o Documento ('.$documentais->tipo_documento.')</h2>',
                        'toggleButton' => [
                            'label' => 'Verso do Documento',
                            'class' => 'btn',
                            'style' =>  'width: 100%',
                    ...
                    $retVal = ($extencao == 'pdf') ? 'min-height: 500px;' : '' ;
                    echo '<embed src="'.Yii::$app->homeUrl.'uploads/propostasdocs/'.$documentais->id.'_selfidoc_'.$documentais->selfie_com_documento.'" 
                                            style="width:100%;height:auto;'.$retVal.'"/>';
        ...
        <div class="col-md-12">
            <div class="col-md-12">
                <?php
                    ...
                    echo '<embed src="'.Yii::$app->homeUrl.'pretendente/report?id='.$model->id.'" style="width:100%;height:auto;min-height: 500px;" />';
