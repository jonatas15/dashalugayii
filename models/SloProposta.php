...
class SloProposta extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['tipo', 'proprietario_info', 'imovel_info', 'opcoes', 'motivo_locacao', 'conj_frente', 'conj_verso', 'frente', 'verso', 'proponentes', 'corresponsavel', 'sexo', 'url'], 'string'],
            ...
            [['tipo_imovel', 'endereco', 'bairro', 'cidade', 'estado', 'atvc_contato', 'shorturl'], 'string', 'max' => 255],
