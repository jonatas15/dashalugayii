...
class SloProposta extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['tipo', 'proprietario_info', 'imovel_info', 'opcoes', 'motivo_locacao', 'conj_frente', 'conj_verso', 'frente', 'verso', 'proponentes'], 'string'],
            [['usuario_id', 'dormitorios', 'aluguel', 'iptu', 'condominio', 'agua', 'luz', 'gas_encanado', 'total', 'numero', 'etapa_andamento', 'conj_num_dependentes'], 'integer'],
            ...
            [['complemento'], 'string', 'max' => 25],
            [['cep', 'atvc_telefone', 'documento_orgao_emissor'], 'string', 'max' => 10],
