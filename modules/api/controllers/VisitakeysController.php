...
class VisitakeysController extends ActiveController
{
    /**
     * Renders the index view for the module
     * @return string
     */
    public $modelClass = 'app\models\Visitchaves';
    public function actions () {
        ...
        switch ($actionbotconversa) {
            ...
            case 'return_id_subscrito':
                ...
                $atualiza = Visitchaves::findOne($id);
            ...
            case 'send_msg':
                ...
                $proposta = Visitchaves::findOne($id);
